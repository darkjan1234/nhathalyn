...
if(isset($_POST['new']) && $_POST['new']==1){
 ...
 $ins_query="insert into `parkdb` (`trn_date`,`platenum`,`car`,`name`,`amount`,`submittedby`)values('$trn_date','$platenum','$car','$name','$amount','$submittedby')";
...
<div class="header">
    ...
    <div class="form">
        <div class="row">
            <div class="leftcolumn">
                ...
                <img class="sm" src="sm.png" alt="smlogo" style="height: 120px;width: 120px; margin-left: 80px; margin-top: 70px; margin-bottom: 30px;"> <a class="a" href="index.php">Admin</a>
    ...
    <div class="rightcolumn">
        ...
        <img class="cimg"src="images/car-park.png">
